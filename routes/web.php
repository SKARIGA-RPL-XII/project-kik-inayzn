    ...
    use App\Models\Ulasan; // Tambahkan import model Ulasan
    ...
    */
    Route::middleware(['auth'])->group(function () {
        ...
        // --- PROFILE USER (DISESUAIKAN UNTUK NOTIFIKASI BALASAN) ---
        Route::get('/profile', function () {
            return Inertia::render('user/profil', [
                'myReviews' => Ulasan::where('user_id', auth()->id())
                    ->with('product') // Mengambil data produk terkait ulasan
                    ->latest()
                    ->get()
            ]); 
        })->name('user.profile');
        ...
        Route::delete('/ulasan/{ulasan}', [UlasanController::class, 'destroy'])->middleware('auth');
