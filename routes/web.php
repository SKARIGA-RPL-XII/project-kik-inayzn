...
use App\Http\Controllers\SavedPropertyController; // Pastikan ini ada
...
Route::middleware(['auth'])->group(function () {
    ...
    // --- FITUR SAVED PROPERTIES (SUDAH DIPERBAIKI) ---
    // Halaman list properti yang disimpan
    Route::get('/saved-properties', [SavedPropertyController::class, 'index'])->name('user.saved');
    // Proses simpan/hapus (Toggle)
